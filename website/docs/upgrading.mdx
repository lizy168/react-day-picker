...
These aliases were kept in v9 for migration and are removed in v10. If you need the historical reference list, see the [v9.14.0 `types/deprecated.ts` source](https://github.com/gpbl/react-day-picker/blob/v9.14.0/src/types/deprecated.ts).
...
| ~`DayLabel`~                   | Use `typeof labelDayButton` instead.                                                                          |
